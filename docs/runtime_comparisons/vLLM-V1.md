...
- [1. 先区分“vLLM 论文时代”和“今天的 vLLM”](#read-01)
- [2. V1 的高层进程结构](#read-02)
- [3. API Server 做什么？](#read-03)
- [4. Engine Core 是 vLLM V1 的心脏](#read-04)
- [5. vLLM V1 Scheduler 的调度单位不是“Request”，而是“Token Budget”](#read-05)
- [6. Continuous Batching 在 vLLM 里怎么体现？](#read-06)
- [7. KV Cache Manager 是另一个核心心脏](#read-07)
- [8. Paged KV Cache 到底如何帮助 scheduler？](#read-08)
- [9. Prefix Caching 在 V1 中是什么？](#read-09)
- [10. Prefix Cache 和 SGLang RadixAttention 是不是一样？](#read-10)
- [11. GPU Worker 是什么？](#read-11)
- [12. Model Runner 又是什么层？](#read-12)
- [13. 多 GPU 时进程结构怎么理解？](#read-13)
- [14. Chunked Prefill 为什么自然融入 V1 Scheduler？](#read-14)
- [15. Speculative Decoding 为什么也能塞进同一 Runtime？](#read-15)
- [16. P/D Disaggregation 在 vLLM 里怎么进入架构？](#read-16)
- [17. vLLM V1 为什么强调“简化核心架构”？](#read-17)
- [18. vLLM 与 FlashInfer 的关系](#read-18)
- [19. 一个请求完整生命周期](#read-19)
- [20. AI Infra 最值得记住的 9 个 Insight](#read-20)
- [21. 推荐源码阅读顺序](#read-21)
- [主要参考资料](#read-22)
