...
- [1. 先明确 TensorRT-LLM 是什么层](#read-01)
- [2. TensorRT、TensorRT-LLM、Triton Inference Server 不要混](#read-02)
- [TensorRT](#read-03)
- [TensorRT-LLM](#read-04)
- [Triton Inference Server](#read-05)
- [3. 为什么 TensorRT-LLM 也必须有 Scheduler？](#read-06)
- [4. In-Flight Batching 是什么？](#read-07)
- [5. 为什么 In-Flight Batching 与 Paged KV Cache 必须配合？](#read-08)
- [6. Runtime 里的 Scheduler 大概在决定什么？](#read-09)
- [7. Executor 是什么？](#read-10)
- [8. 模型到底怎么跨多 GPU？](#read-11)
- [Tensor Parallelism](#read-12)
- [Pipeline Parallelism](#read-13)
- [Expert Parallelism](#read-14)
- [9. Runtime 与 Kernel 是什么关系？](#read-15)
- [10. TensorRT-LLM 为什么高度强调 Quantization？](#read-16)
- [11. 为什么 Paged Attention、IFB、Scheduler 是一组功能？](#read-17)
- [12. Chunked Context / Chunked Prefill 在这里做什么？](#read-18)
- [13. TensorRT-LLM 当前为何同时存在“编译引擎”和 PyTorch workflow 的概念？](#read-19)
- [14. TensorRT-LLM 与 vLLM 最大的气质差异是什么？](#read-20)
- [TensorRT-LLM](#read-21)
- [vLLM](#read-22)
- [15. TensorRT-LLM 与 FlashAttention / FlashInfer 的关系](#read-23)
- [16. TensorRT-LLM 与 DistServe / P-D 分离的关系](#read-24)
- [17. 一个请求在 TensorRT-LLM 中的概念路径](#read-25)
- [18. AI Infra 最值得记住的 8 个 Insight](#read-26)
- [19. 推荐进一步读源码/文档的顺序](#read-27)
- [主要参考资料](#read-28)
