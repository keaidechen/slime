...
<a id="1-不要把-cudacublascutlass-当成同一层"></a>

## 不要把 CUDA、cuBLAS、CUTLASS 当成同一层
...
<a id="5-cute-最难的地方layout-不是行主序列主序这么简单"></a>

## CuTe 最难的地方：Layout 不是“行主序/列主序”这么简单
...
<a id="6-cutlass-4x-与-cute-dsl"></a>

## CUTLASS 4.x 与 CuTe DSL
...
<a id="7-blackwell-为什么推动-cutlasscute-变得更重要"></a>

## Blackwell 为什么推动 CUTLASS/CuTe 变得更重要？
...
<a id="8-cutlasstritontilelang-怎么选"></a>

## CUTLASS、Triton、TileLang 怎么选？
...
## 先建立软件栈：CUDA、cuBLAS、CUTLASS、Triton 分别是什么？
