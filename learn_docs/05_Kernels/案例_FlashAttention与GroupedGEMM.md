...
<a id="1-标准-attention-的问题不只是-os2-计算"></a>
...
<a id="2-online-softmax-为什么允许分块"></a>
...
<a id="4-为什么-flashattention-4-需要新的实现思路"></a>
...
<a id="8-为什么大-gemm-的最佳策略不能直接用于-moe"></a>
...
<a id="10-pytorch-grouped_mm-与-transformer-engine-grouped_gemm"></a>
