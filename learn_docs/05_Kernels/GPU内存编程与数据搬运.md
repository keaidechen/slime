...
<a id="1-为什么-ai-kernel-经常不是算得慢而是搬得慢"></a>

## 为什么 AI Kernel 经常不是“算得慢”，而是“搬得慢”？
...
<a id="2-bandwidthlatency-与-throughput"></a>

## Bandwidth、Latency 与 Throughput
...
<a id="3-arithmetic-intensity-与-roofline"></a>
...
<a id="4-coalescing为什么连续地址更快"></a>

## Coalescing：为什么连续地址更快？
...
<a id="5-shared-memory-与-tiling"></a>
...
<a id="6-shared-memory-bank-conflict"></a>
...
<a id="7-register-pressure-与-spill"></a>
...
<a id="8-double-buffer-与-software-pipeline"></a>

## Double Buffer 与 Software Pipeline
...
<a id="10-kernel-fusion-的收益与边界"></a>

## Kernel Fusion 的收益与边界
...
<a id="11-2026-年的新趋势数据移动成为编程模型的一等公民"></a>

## 2026 年的新趋势：数据移动成为编程模型的一等公民
