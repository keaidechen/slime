...
> 类型：算子机制。前置：[基础概念](../00_Physical_Foundations/计算电路与处理器.md)。关联：[机制与演进](算子优化的问题演进.md)。

<a id="1-gemm-为什么是-ai-infra-的发动机"></a>
...
<a id="5-batched-gemmgrouped-gemm-与普通-gemm"></a>
...
<a id="10-kernel-fusionpersistentwarp-specialization-的关系"></a>
