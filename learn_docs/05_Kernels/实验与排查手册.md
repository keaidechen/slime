...
<a id="6-判断-compute-bound-与-memory-bound"></a>
...
<a id="9-tritontilelangcute-dsl-专项排查"></a>

## Triton/TileLang/CuTe DSL 专项排查
...
<a id="10-grouped-gemm-benchmark-不应只用均匀负载"></a>

## Grouped GEMM Benchmark 不应只用均匀负载
...
<a id="11-flashattention-benchmark-不应只报一个序列长度"></a>

## FlashAttention Benchmark 不应只报一个序列长度
