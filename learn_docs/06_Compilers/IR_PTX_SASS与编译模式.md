...
<a id="2-ptx-不是-gpu-最终直接执行的代码"></a>

## PTX 不是 GPU 最终直接执行的代码
...
<a id="4-compute-capability-与目标架构"></a>

## Compute Capability 与目标架构
...
<a id="7-cuda-tile-ir-为什么值得关注"></a>

## CUDA Tile IR 为什么值得关注？
...
<a id="概念辨析迁移自原笔记-04"></a>

## 概念辨析

<a id="04从-nvcc-编译到-kernel-launchcuda-代码是怎么真正联通-gpu-的"></a>

### 从 nvcc 编译到 Kernel Launch：CUDA 代码是怎么真正“联通” GPU 的？
...
## PTX、cubin、SASS：Kernel 最终到底被编译成什么？
