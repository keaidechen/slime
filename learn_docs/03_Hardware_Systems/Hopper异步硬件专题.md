...
## Hopper/H100 时代的新硬件概念：为 FlashAttention-3 做准备
...
#### 5 什么是 Warp Specialization（warp 专职化：不同 warp group 承担不同流水线职责）？
...
#### 6 Double Buffer / Multi-stage Pipeline 是什么？
...
#### 7 为什么 Tensor Core 变得越快，Softmax 反而越值得优化？
...
#### 8 FP16、BF16、FP8 为什么会影响 kernel 设计？
...
#### 9 把 Hopper 硬件能力映射到 FlashAttention-3
