...
> 类型：设备执行机制。前置：[基础概念](主机设备与执行边界.md)。关联：[机制与演进](CUDA_Stream与依赖.md)。
...
<a id="2-vector_add-到底创建了什么"></a>

## `vector_add<<<4096, 256>>>` 到底创建了什么？
...
<a id="3-为什么一个-block-不能拆到两个-sm"></a>

## 为什么一个 Block 不能拆到两个 SM？
...
<a id="5-kernel-launch-为什么通常是异步的"></a>

## Kernel Launch 为什么通常是异步的？
...
<a id="7-warp-scheduler-为什么能隐藏延迟"></a>

## Warp Scheduler 为什么能隐藏延迟？
...
<a id="9-hopperblackwell-为什么让旧模型变得不够用"></a>

## Hopper/Blackwell 为什么让旧模型变得不够用？
...
<a id="概念辨析迁移自原笔记-05"></a>

## 概念辨析

<a id="05block-如何占用-sm-资源warp-又是如何被调度和-issue-的"></a>

### Block 如何占用 SM 资源？Warp 又是如何被调度和 Issue 的？
