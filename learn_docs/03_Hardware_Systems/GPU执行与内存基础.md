...
> 类型：GPU 系统综述。前置：[基础概念](../00_Physical_Foundations/局部性与数据移动.md)。关联：[机制与演进](../05_Kernels/算子优化的问题演进.md)。
...
> 前置：tensor 与进程。本文整编自论文共享基础，保留原有直觉与算例。
